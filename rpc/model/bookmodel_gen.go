...
var (
	...
	bookRowsExpectAutoSet   = strings.Join(stringx.Remove(bookFieldNames, "create_time", "update_time", "create_t", "update_at"), ",")
	bookRowsWithPlaceHolder = builder.PostgreSqlJoin(stringx.Remove(bookFieldNames, "book", "create_time", "update_time", "create_at", "update_at"))
